...
async function run() {
	...
	console.log("\\n--- Testing createExtension ---");
	const createResult = await createExtension("pi-test-ext", TARGET_DIR, TEMPLATE_DIR);
	...
	const retrofit1 = await retrofitExtension(TARGET_DIR);
	console.log(retrofit1);
	...
	const retrofit2 = await retrofitExtension(TARGET_DIR);
	console.log(retrofit2);
